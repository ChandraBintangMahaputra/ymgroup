...
const MostCreatorCourse: React.FC = () => {
  const [data, setData] = useState<{ name: string; total_course: string }[]>([]);
  const {darkMode} = useDarkMode()

  useEffect(() => {
    fetch(`${import.meta.env.VITE_PREFIX_BACKEND}/api/dashboard/most-created-course`)
  ...
  return (
    ...
    >
      ...
      5 Most Creator Course All The Time
      </p>
...
export default MostCreatorCourse;
